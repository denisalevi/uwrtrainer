...
INSERT INTO "new_SessionLog" ("category", "createdAt", "date", "details", "durationMin", "id", "missReason", "practiceSlotId", "status", "userId") SELECT "category", "createdAt", "date", "details", "durationMin", "id", "missReason", "practiceSlotId", "status", "userId" FROM "SessionLog";
