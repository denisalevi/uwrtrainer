...
export const en = {
  ...
  "plan.committedPracticesHint": "Optional — mark which specific practice(s) you usually aim for. Complications go in your availability note above.",
  "plan.rugbyPerWeek": "Rugby practices per week",
  "plan.customActivities": "Custom activities",
  "plan.customActivitiesHint": "Add your own, e.g. climbing, swimming, spinning.",
...
export const de: Record<DictKey, string> = {
  ...
  "plan.committedPracticesHint": "Optional — markiere, welche konkreten Trainings du normalerweise anpeilst. Besonderheiten in die Verfügbarkeitsnotiz oben.",
  "plan.rugbyPerWeek": "Rugby-Trainings pro Woche",
  "plan.customActivities": "Eigene Aktivitäten",
  "plan.customActivitiesHint": "Füge eigene hinzu, z. B. Klettern, Schwimmen, Spinning.",
