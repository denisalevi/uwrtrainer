...
export const en = {
  ...
  "auth.resetRequested": "If an account exists for this address, a reset link is on its way. Check your inbox.",
  ...
  "auth.checkEmailBody": "We've sent a confirmation link to {email}. Click it, then sign in.",
  "auth.emailNotVerified": "Please confirm your email address first — check your inbox for the link.",
  "auth.resendButton": "Resend link",
  "auth.verificationSent": "If an unverified account exists for this address, a fresh link is on its way.",
...
export const de: Record<DictKey, string> = {
  ...
  "auth.resetRequested": "Falls ein Konto mit dieser Adresse existiert, ist ein Reset-Link unterwegs. Schau in dein Postfach.",
  ...
  "auth.checkEmailBody": "Wir haben einen Bestätigungslink an {email} geschickt. Klick ihn an und melde dich dann an.",
  ...
  "auth.verificationSent": "Falls ein unbestätigtes Konto mit dieser Adresse existiert, ist ein neuer Link unterwegs.",
