...
export const en = {
  ...
  "teams.title": "Teams",
  "teams.member": "member",
  "teams.notMember": "not a member",
  "teams.joinCode": "Join a team by registration code",
...
export const de: Record<DictKey, string> = {
  ...
  "teams.notMember": "kein Mitglied",
  "teams.joinCode": "Team per Registrierungscode beitreten",
