...
export const en = {
  ...
  "auth.forgotBody": "Enter your email address and we'll send you a link to choose a new password.",
  "auth.forgotButton": "Send reset link",
  "auth.resetRequested": "If an account exists for this address, a reset link is on its way. Check your inbox — and your spam folder if you don't see it.",
  "auth.resetUnavailable": "Password reset by email isn't set up on this server yet — ask your admin to reset your password.",
  "auth.resetTitle": "Choose a new password",
  "auth.newPassword": "New password",
  "auth.resetButton": "Set new password",
  "auth.resetDone": "Password changed — you can sign in with it now.",
  "auth.resetLinkInvalid": "This reset link is invalid, expired, or already used. Request a new one.",
  "auth.checkEmailTitle": "Check your inbox",
  "auth.checkEmailBody": "We've sent a confirmation link to {email}. Click it, then sign in. No email? Check your spam folder — it sometimes lands there.",
  "auth.emailNotVerified": "Please confirm your email address first — check your inbox for the link.",
  "auth.resendButton": "Resend link",
  "auth.verificationSent": "If an unverified account exists for this address, a fresh link is on its way. If you don't see it, check your spam folder.",
  "auth.mailCooldown": "A link was sent just now — please wait a few minutes before requesting another.",
  "auth.mailSendFailed": "The email couldn't be sent. Please try again in a few minutes.",
  "auth.verifyTitle": "Email confirmation",
  "auth.verifySuccess": "Your email is confirmed — you can sign in now.",
  "auth.verifyInvalid": "This link is invalid, expired, or already used. If you clicked it before, your email may already be confirmed — just sign in.",
  "auth.goToLogin": "Go to sign-in",

  // Outbound emails (src/lib/mail.ts), localized to the recipient's stored locale.
  "mail.greeting": "Hi {name},",
  "mail.verifySubject": "Confirm your email — UWR Trainer",
  "mail.verifyIntro": "welcome to UWR Trainer! Click the button below to confirm your email address and activate your account.",
  "mail.verifyButton": "Confirm email",
  "mail.verifyExpiry": "The link is valid for 24 hours.",
  "mail.resetSubject": "Reset your password — UWR Trainer",
  "mail.resetIntro": "someone (hopefully you) asked to reset your UWR Trainer password. Click the button below to choose a new one.",
  ...
  "set.deleteOwnTitle": "Delete my account",
  "set.deleteOwnHint": "Remove your login — training data stays",
  "set.deleteOwnIntro": "This deletes your login (email and password) — your tracking data is NOT deleted. You'll stay on the roster as a member without an account, and your history can even be re-claimed with a new signup. If you want your data fully deleted too, write a mail to {mail}.",
  "set.deleteOwnConfirm": "Delete your login? Your tracking data is NOT deleted — for full deletion, mail {mail}. Continue?",
  "set.deleteOwnButton": "Delete my account",
  "set.deleteOwnLastAdmin": "You're the only admin — promote another admin first (Manage users), then you can delete your account.",
  "auth.accountDeleted": "Your account was deleted. Your tracking data is kept on the roster and can be re-claimed by signing up again.",

  "users.reassignTitle": "Reassign account",
  "users.reassignHint": "Move a login to a different roster member",
  "users.reassignIntro": "Moves a login (email + password) to a member without an account — for when someone ticked the wrong name at signup. All training data stays where it is; only the login moves. The affected person is signed out everywhere.",
  "users.reassignSource": "Account to move",
  "users.reassignTarget": "Move to roster member",
  "users.reassignButton": "Move account",
  "users.reassignConfirm": "Move the login of \"{source}\" to \"{target}\"? \"{source}\" becomes an account-less roster member.",
  "users.reassignNoTargets": "Nothing to reassign — this needs at least one account and one member without an account.",
  ...
  // ── Strength hub + 5/3/1 naming ──
  "strength.hubIntro": "Your 5/3/1 program and your own routines — whatever is active here shows up when you log a strength session.",
  "strength.hubPrograms": "Guided program",
  "strength.wendlerTitle": "5/3/1 Wendler",
  "strength.wendlerBlurb": "The classic barbell progression: squat, bench, deadlift and press in 3-week waves plus a deload — weights step up automatically as you log. Works with bodyweight variants too.",
  "strength.wendlerNotSetUp": "Not set up",
  "strength.wendlerSetUp": "Set up",
  "strength.wendlerPausedHint": "Paused — its days are hidden when logging until you resume. Your maxima and progress are kept.",

  // ── Custom routines (docs/plans/custom-routines.md) ──
  "routines.mine": "My routines",
  "routines.team": "Team routines",
  "routines.memberRoutines": "Routines",
  "routines.new": "New routine",
  "routines.edit": "Edit routine",
  "routines.editorIntro": "Name it, add your exercises with target sets — then log it from the strength logger.",
  "routines.name": "Routine name",
  "routines.namePlaceholder": "e.g. Monday full body",
  "routines.noneYet": "No routines yet — create one, or copy one from a teammate's page.",
  "routines.empty": "No exercises yet",
  "routines.active": "Active",
  "routines.archived": "Archived",
  "routines.paused": "Paused",
  "routines.activeHint": "Active routines appear in the strength logger and are visible to your teammates (they can copy them). Archived ones stay here, hidden from both.",
  "routines.open": "Open",
  ...
  "routines.copy": "Copy",
  "routines.copyToMine": "Copy to my routines",
  "routines.copySuffix": "copy",
  "routines.publish": "Publish to team",
  "routines.unpublish": "Unpublish",
  "routines.publishedBadge": "Team",
  "routines.byAuthor": "by {name}",
  "routines.badge": "Routine",
  "routines.measure": "Measure",
  "routines.measure.KG_REPS": "Weight × reps",
  "routines.measure.REPS": "Reps only",
  "routines.measure.SECONDS": "Seconds (timed)",
  "routines.measure.KG_SECONDS": "Weight × seconds",
  "routines.tempo": "Tempo",
  "routines.secondsShort": "sec",
  "routines.restSeconds": "Rest between sets (seconds)",
  "routines.moveUp": "Move up",
...
export const de: Record<DictKey, string> = {
  ...
  "auth.forgotBody": "Gib deine E-Mail-Adresse ein und wir schicken dir einen Link, um ein neues Passwort zu wählen.",
  "auth.forgotButton": "Reset-Link senden",
  "auth.resetRequested": "Falls ein Konto mit dieser Adresse existiert, ist ein Reset-Link unterwegs. Schau in dein Postfach — und ggf. im Spam-Ordner.",
  "auth.resetUnavailable": "Passwort-Reset per E-Mail ist auf diesem Server noch nicht eingerichtet — bitte deinen Admin, das Passwort zurückzusetzen.",
  "auth.resetTitle": "Neues Passwort wählen",
  "auth.newPassword": "Neues Passwort",
  "auth.resetButton": "Neues Passwort speichern",
  "auth.resetDone": "Passwort geändert — du kannst dich jetzt damit anmelden.",
  "auth.resetLinkInvalid": "Dieser Reset-Link ist ungültig, abgelaufen oder schon benutzt. Fordere einen neuen an.",
  "auth.checkEmailTitle": "Schau in dein Postfach",
  "auth.checkEmailBody": "Wir haben einen Bestätigungslink an {email} geschickt. Klick ihn an und melde dich dann an. Keine E-Mail? Schau bitte auch im Spam-Ordner — dort landet sie manchmal.",
  "auth.emailNotVerified": "Bitte bestätige zuerst deine E-Mail-Adresse — der Link ist in deinem Postfach.",
  "auth.resendButton": "Link erneut senden",
  "auth.verificationSent": "Falls ein unbestätigtes Konto mit dieser Adresse existiert, ist ein neuer Link unterwegs. Falls du nichts findest, schau bitte auch im Spam-Ordner.",
  "auth.mailCooldown": "Es wurde gerade erst ein Link verschickt — bitte warte ein paar Minuten.",
  "auth.mailSendFailed": "Die E-Mail konnte nicht gesendet werden. Bitte versuche es in ein paar Minuten erneut.",
  "auth.verifyTitle": "E-Mail-Bestätigung",
  "auth.verifySuccess": "Deine E-Mail ist bestätigt — du kannst dich jetzt anmelden.",
  "auth.verifyInvalid": "Dieser Link ist ungültig, abgelaufen oder schon benutzt. Falls du ihn schon angeklickt hast, ist deine E-Mail vielleicht schon bestätigt — melde dich einfach an.",
  "auth.goToLogin": "Zur Anmeldung",

  "mail.greeting": "Hallo {name},",
  "mail.verifySubject": "Bestätige deine E-Mail — UWR Trainer",
  "mail.verifyIntro": "willkommen beim UWR Trainer! Klicke auf den Button unten, um deine E-Mail-Adresse zu bestätigen und dein Konto zu aktivieren.",
  "mail.verifyButton": "E-Mail bestätigen",
  "mail.verifyExpiry": "Der Link ist 24 Stunden gültig.",
  "mail.resetSubject": "Passwort zurücksetzen — UWR Trainer",
  "mail.resetIntro": "jemand (hoffentlich du) möchte dein UWR-Trainer-Passwort zurücksetzen. Klicke auf den Button unten, um ein neues zu wählen.",
  ...
  "set.deleteOwnTitle": "Mein Konto löschen",
  "set.deleteOwnHint": "Login entfernen — Trainingsdaten bleiben",
  "set.deleteOwnIntro": "Das löscht deinen Login (E-Mail und Passwort) — deine Trainingsdaten werden NICHT gelöscht. Du bleibst als Mitglied ohne Konto auf der Teamliste, und deine Historie kann bei einer neuen Registrierung sogar wieder übernommen werden. Wenn du auch deine Daten vollständig löschen lassen willst, schreib eine Mail an {mail}.",
  "set.deleteOwnConfirm": "Login löschen? Deine Trainingsdaten werden NICHT gelöscht — für vollständige Löschung schreib an {mail}. Fortfahren?",
  "set.deleteOwnButton": "Mein Konto löschen",
  "set.deleteOwnLastAdmin": "Du bist der einzige Admin — ernenne zuerst einen anderen Admin (Mitglieder verwalten), dann kannst du dein Konto löschen.",
  "auth.accountDeleted": "Dein Konto wurde gelöscht. Deine Trainingsdaten bleiben auf der Teamliste erhalten und können bei einer neuen Registrierung wieder übernommen werden.",

  "users.reassignTitle": "Konto neu zuordnen",
  "users.reassignHint": "Login zu einem anderen Teammitglied verschieben",
  "users.reassignIntro": "Verschiebt einen Login (E-Mail + Passwort) zu einem Mitglied ohne Konto — falls jemand bei der Registrierung den falschen Namen angeklickt hat. Alle Trainingsdaten bleiben, wo sie sind; nur der Login wandert. Die betroffene Person wird überall abgemeldet.",
  "users.reassignSource": "Zu verschiebendes Konto",
  "users.reassignTarget": "Verschieben zu Mitglied",
  "users.reassignButton": "Konto verschieben",
  "users.reassignConfirm": "Login von \"{source}\" zu \"{target}\" verschieben? \"{source}\" wird zum Mitglied ohne Konto.",
  "users.reassignNoTargets": "Nichts zuzuordnen — dafür braucht es mindestens ein Konto und ein Mitglied ohne Konto.",
  ...
  "plan.committedPractices": "Team-Trainings, die ich mir vorgenommen habe",
  "plan.committedPracticesHint": "Optional — markiere, welche konkreten Trainings du dir normalerweise vornimmst. Besonderheiten in die Verfügbarkeitsnotiz unten.",
  ...
  // ── Kraft-Hub + 5/3/1-Benennung ──
  "strength.hubIntro": "Dein 5/3/1-Programm und deine eigenen Routinen — was hier aktiv ist, taucht beim Loggen einer Kraft-Einheit auf.",
  "strength.hubPrograms": "Geführtes Programm",
  "strength.wendlerTitle": "5/3/1 Wendler",
  "strength.wendlerBlurb": "Die klassische Langhantel-Progression: Kniebeuge, Bankdrücken, Kreuzheben und Schulterdrücken in 3-Wochen-Wellen plus Deload — die Gewichte steigen automatisch mit deinen Logs. Geht auch mit Körpergewichts-Varianten.",
  "strength.wendlerNotSetUp": "Nicht eingerichtet",
  "strength.wendlerSetUp": "Einrichten",
  "strength.wendlerPausedHint": "Pausiert — die Tage sind beim Loggen ausgeblendet, bis du fortsetzt. Deine Maxima und dein Fortschritt bleiben erhalten.",

  // ── Eigene Routinen (docs/plans/custom-routines.md) ──
  "routines.mine": "Meine Routinen",
  "routines.team": "Team-Routinen",
  "routines.memberRoutines": "Routinen",
  "routines.new": "Neue Routine",
  "routines.edit": "Routine bearbeiten",
  "routines.editorIntro": "Gib ihr einen Namen, füge Übungen mit Ziel-Sätzen hinzu — geloggt wird sie dann im Kraft-Logger.",
  "routines.name": "Name der Routine",
  "routines.namePlaceholder": "z. B. Montag Ganzkörper",
  "routines.noneYet": "Noch keine Routinen — erstelle eine oder kopiere eine von der Seite eines Teammitglieds.",
  "routines.empty": "Noch keine Übungen",
  "routines.active": "Aktiv",
  "routines.archived": "Archiviert",
  "routines.paused": "Pausiert",
  "routines.activeHint": "Aktive Routinen erscheinen im Kraft-Logger und sind für dein Team sichtbar (es kann sie kopieren). Archivierte bleiben hier, aber überall sonst ausgeblendet.",
  "routines.open": "Öffnen",
  "routines.pause": "Pausieren",
  "routines.resume": "Fortsetzen",
  "routines.archive": "Archivieren",
  "routines.activate": "Aktivieren",
  "routines.duplicate": "Duplizieren",
  "routines.copy": "Kopieren",
  "routines.copyToMine": "Zu meinen Routinen kopieren",
  "routines.copySuffix": "Kopie",
  "routines.publish": "Fürs Team veröffentlichen",
  "routines.unpublish": "Nicht mehr veröffentlichen",
  "routines.publishedBadge": "Team",
  "routines.byAuthor": "von {name}",
  "routines.badge": "Routine",
  "routines.measure": "Messgröße",
  "routines.measure.KG_REPS": "Gewicht × Wdh.",
  "routines.measure.REPS": "Nur Wiederholungen",
  "routines.measure.SECONDS": "Sekunden (auf Zeit)",
  "routines.measure.KG_SECONDS": "Gewicht × Sekunden",
  "routines.tempo": "Tempo",
  "routines.secondsShort": "Sek.",
  "routines.restSeconds": "Pause zwischen Sätzen (Sekunden)",
  "routines.moveUp": "Nach oben",
