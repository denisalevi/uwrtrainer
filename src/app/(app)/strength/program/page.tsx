...
/** The 5/3/1 Wendler program detail: setup wizard when none is configured, else the full
 *  schedule/maxima view. Reached from the strength hub's 5/3/1 card. */
export default async function StrengthProgramPage() {
  ...
  return (
    <div className="space-y-4">
      ...
      <header>
        <h1 className="text-2xl font-bold text-slate-900">{t("strength.wendlerTitle")}</h1>
